    ...
    <div id="Skills" className='m-[1rem] flex flex-col md:flex-col items-center justify-center md:h-dvh h-auto md:ml-8 md:m-[2rem] p-4'>
      ...
      <div className='w-full md:w-fit p-8 rounded-2xl md:h-dvh flex justify-center my-5 md:mt-0  bg-slate-700'>
        <div className='flex flex-col  gap-3 text-gray-200'>
          ...
          <h1 className='flex gap-4 items-center md:text-3xl text-2xl font-semibold text-gray-900'><FaLaptopCode className=' md:text-3xl text-4xl'/> Frontend Development </h1>
          <p className='md:text-2xl text-xl text-center'>- HTML5, CSS3 (Flexbox, Grid), JavaScript (ES6+), React (Hooks, Context API)</p>
          <h1 className='flex gap-4 items-center md:text-3xl text-2xl font-semibold text-gray-900'><FaTools className=' md:text-3xl text-4xl'/>Tools & Technologies</h1>
          <p className='md:text-2xl text-xl text-center'>- Git & GitHub, npm/yarn, VS Code, Chrome DevTools, Responsive Design</p>
